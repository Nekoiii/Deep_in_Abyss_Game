...
const QMetaObject Mushroom::staticMetaObject = {
    { &Monster::staticMetaObject, qt_meta_stringdata_Mushroom.data,
      qt_meta_data_Mushroom,  qt_static_metacall, nullptr, nullptr}
};
...
void *Mushroom::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Mushroom.stringdata0))
        return static_cast<void*>(const_cast< Mushroom*>(this));
