...
QT_MOC_LITERAL(1, 9, 13), // "sig_moveItems"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "sig_gameover"
QT_MOC_LITERAL(4, 37, 10), // "slt_updata"
QT_MOC_LITERAL(5, 48, 13), // "slt_moveItems"
QT_MOC_LITERAL(6, 62, 12), // "slt_gameover"
QT_MOC_LITERAL(7, 75, 8) // "slt_back"

    },
    "MainView\0sig_moveItems\0\0sig_gameover\0"
    "slt_updata\0slt_moveItems\0slt_gameover\0"
    "slt_back"
};
...
void MainView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_moveItems(); break;
        case 1: _t->sig_gameover(); break;
        case 2: _t->slt_updata(); break;
        case 3: _t->slt_moveItems(); break;
        case 4: _t->slt_gameover(); break;
        case 5: _t->slt_back(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainView::sig_moveItems)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MainView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainView::sig_gameover)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MainView::sig_moveItems()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MainView::sig_gameover()
{
